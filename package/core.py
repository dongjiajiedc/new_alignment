...
# def alignment_process(cell_path1,cell_path2,folder_path2,radius1,radius2,c1,c2,epoches1,epoches2):
    
    
#     loss = merge_cells_by_radius(cell_path1,folder_path1,radius1)
#     print("cell merge loss for dataset1: {}".format(loss))

#     loss = merge_cells_by_radius(cell_path2,folder_path2,radius2)
...
def alignment_process_st(cell_path1,cell_path2,folder_path1,folder_path2,radius1,radius2,c1,c2,epoches1,epoches2,contin=True,resolution=0.5):
    ...
    if (contin==False) or ((os.path.exists(folder_path1+'merge_cell_data.csv') and os.path.exists(folder_path1 + 'merge_cell_meta.csv')) == False):
        ...
        loss1 = merge_st_by_radius(cell_path1,folder_path1,radius1)
        print("cell merge loss for dataset1: {}\n".format(loss1))
        log1.write("cell merge loss for dataset1: {}\n".format(loss1))
    ...
    if(contin==False) or ((os.path.exists(folder_path2+'merge_cell_data.csv') and os.path.exists(folder_path2 + 'merge_cell_meta.csv')) == False):
        ...
        loss2 = merge_st_by_radius(cell_path2,folder_path2,radius2)
        print("cell merge loss for dataset2: {}".format(loss2))
        log2.write("cell merge loss for dataset2: {}\n".format(loss2))
